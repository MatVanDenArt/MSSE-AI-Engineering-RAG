...
def test_chat_endpoint_success(mocker):
    ...
    mocker.patch.object(api.retriever, 'get_relevant_documents', return_value=mock_docs)
    ...
    api.retriever.get_relevant_documents.assert_called_once_with("What is the policy?")
